...
export function Faq() {
  return (
    ...
    className={Styles.accordion}>
      ...
      >
        <p>
          'Publicidade online, também conhecida como tráfego pago, refere-se às
          estratégias e técnicas de marketing que envolvem o pagamento para
      ...
      >
        <p>
          ...
          gerado a partir dessas campanhas. Elas ajudam a avaliar a eficácia de
          suas estratégias de marketing e tomar decisões informadas para
      ...
      >
        ...
        <p>
          ...
          número de impressões do anúncio, expressa em porcentagem. Essa métrica
          ajuda a avaliar a atratividade do anúncio e a relevância para o
          público-alvo.
        </p>
        <p>
          Taxa de Conversão: A proporção entre o número de conversões e o número
          de cliques no anúncio. Uma conversão pode ser definida de acordo com o
          objetivo da campanha, como uma venda, preenchimento de formulário,
          assinatura de newsletter, entre outros. Essa métrica mostra o sucesso
          em transformar o tráfego em ações desejadas.
        </p>
        <p>
          Custo por Clique (CPC): O custo médio para cada clique recebido no
          anúncio. Essa métrica ajuda a avaliar o custo-benefício da campanha e
          a comparar diferentes canais ou anúncios.
        </p>
        <p>
          Custo por Aquisição (CPA): O custo médio para adquirir uma conversão.
          Essa métrica é especialmente relevante para campanhas com foco em
          vendas ou geração de leads. Ela ajuda a avaliar o retorno sobre o
          investimento e a eficiência da campanha em gerar resultados
        </p>
        <p>
          Retorno sobre o Investimento (ROI): A relação entre o lucro obtido e o
          investimento em publicidade. Essa métrica é crucial para determinar se
          a campanha está gerando um retorno positivo ou negativo em relação aos
          recursos investidos.
        </p>
      </AccordionItem>
      <AccordionItem
